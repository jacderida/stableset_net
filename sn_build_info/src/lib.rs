...
pub fn full_version_info(app_name: &str, crate_version: &str, protocol_version: Option<&str>) -> String {
    let mut info = format!("{} v{}", app_name, crate_version);
...
pub fn version_string(app_name: &str, crate_version: &str, protocol_version: Option<&str>) -> String {
